...
<Properties>
  <View=-20,-119,1033,714,1,0,133>
  <Grid=10,10,1>
  <DataSet=oneLGAD_oneSiMS_resistorcapacitorback.dat>
  <DataDisplay=Plots.dpl>
  <OpenDisplay=1>
  <Script=oneLGAD_oneSiMS_resistorcapacitorback.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <Ifile I1 1 500 440 18 -26 0 1 "current.dat" 1 "linear" 0 "no" 0 "2" 1 "0" 1>
  <R R1 1 250 350 -26 15 0 0 "100 MOhm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "US" 0>
  <R R2 1 290 510 -26 15 0 0 "100 MOhm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "US" 0>
  <C C1 1 290 570 -26 17 0 0 "100 pF" 1 "" 0 "neutral" 0>
</Components>
<Wires>
  <160 180 160 200 "" 0 0 0 "">
  <210 500 210 510 "" 0 0 0 "">
  <160 200 210 200 "" 0 0 0 "">
  <210 510 260 510 "" 0 0 0 "">
